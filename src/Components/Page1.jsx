...
function Page1(){
    ...
    const classes = [
        ...
        <p key={4}  className='class'>👨‍🏫 CISCO 9:00am - 12:00pm <span className='yellow-side'>F2F</span><br/><br/><span className='async'>📚 Asynchronous: Database, Data Structure</span></p>,
        ...
        <p key={7}  className='class'>👨‍🏫Data Structure 12:00pm - 3:00pm <span className='yellow-side'>F2F EXAM</span> <br/><br/>
        ...
        <p key={8}  className='class'>👨‍🏫PE3 10:00am - 12:00pm <span className='yellow-side'> Online </span> <br/>
            👨‍🏫Web Programming 2:00pm - 5:00pm <span className='yellow-side'>F2F @ CISCO Lab</span></p>,
