...
function Page1(){
    ...
    const classes = [
        ...
        <p key={5}  className='class'>
            <span>NET1</span><br/>
            <span className="yellow-side"> 7:00AM - 10:00AM </span> <span className='async'>* async</span> <br/><br/>
            ...
            <span className="async"> * "supposedly May 20 pa pasok, pero na move pala capstone for Tuesday. As of now, wala pa update if May 20 parin pasok"</span> <br/>
    ...
    const anouncement = <p>
       <h2>Schedule</h2>
       <p>Back to normal schedule na</p>
    </p>
    ...
    function scrollDown() {
      ...
      useEffect(() => {
        const lastUpdate = "5/12/2025"; // MM/DD/YYYY
    ...
    return(
        ...
        <div id="main">
            ...
            <div id="modal" style={toogleModal}>
                <h2> </h2>
                {anouncement}
                    <p className='close' onClick={toggleOffModal}>Sige</p>
            </div>
