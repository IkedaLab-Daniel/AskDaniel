...
function Page1(){
    ...
    const classes = [
        ...
        <p key={4}  className='class'>👨‍🏫 CISCO 9:00am - 12:00pm</p>,

        <p key={5}  className='class'>👨‍🏫 Accounting 3:00pm - 6:00pm</p>,

        <p key={6}  className='class'>📚Understanding the Self 11:00am - 2:00pm <br/>
            👨‍🏫Science 6:00pm - 9:00pm  <br/>
            👨‍🏫Database 8:00am - 11:00am</p>,

        <p key={7}  className='class'>👨‍🏫Data Structure 12:00pm - 3:00pm <br/>
            📚Art Appreciation 6:00pm - 9:00pm</p>,

        <p key={8}  className='class'>👨‍🏫PE3 10:00am - 12:00pm <span className='yellow-side'>Online</span> <br/><br/>
            👨‍🏫Web Programming 2:00pm - 5:00pm <span className='yellow-side'>F2F</span></p>,

        <p key={9}  className='class'>❤️No Class</p>,
    ];

    const Tasks = <p key="1">📌 CISCO netacad Module 1-2 <span className='yellow-side'>Self-paced</span>  <br/><br/>
                📌Art Appreciation Word Hunt - Module 1 <span className='yellow-side'>Deadline: Sep.19</span> <br/><br/>
